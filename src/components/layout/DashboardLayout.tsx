...
export const DashboardLayout = ({
  ...
  return <div className="min-h-screen flex font-poppins">
      <aside className="w-64 text-white p-4 bg-zinc-200">
        <div className="mb-8">
          <img src="https://raw.githubusercontent.com/devopenledger/openledger-assets/main/logo-livee.png" alt="Livee" className="h-8" />
        </div>
        <nav>
          {role === 'user' && <div className="space-y-2">
          ...
          {role === 'agent' && <div className="space-y-2">
          ...
          {role === 'developer' && <div className="space-y-2">
